...
/*$query = "SELECT first_name FROM managers WHERE manager_id='{$username}'";
...
<main role="main">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('../Images/manager1.jpg'); background-repeat: no-repeat; background-size: 1550px 750px" >
          ...
          <div class="carousel-item" style="background-image: url('../Images/manager2.jpg'); background-repeat: no-repeat; background-size: 1550px 750px">
            <div class="carousel-caption d-none d-md-block">
              <h3>Second Slide</h3>
