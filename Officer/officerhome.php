...
/*$query = "SELECT first_name FROM officers WHERE officer_id='{$username}'";
...
<main role="main">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('../Images/officer1.jpg'); background-repeat: no-repeat; background-size: 1550px 750px" >
          ...
          <div class="carousel-item" style="background-image: url('../Images/officer2.jpg'); background-repeat: no-repeat; background-size: 1550px 750px">
            <div class="carousel-caption d-none d-md-block">
              <h3>Second Slide</h3>
